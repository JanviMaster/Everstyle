...
const ShippingDetails = () => {
  return (
    <div className="shipping-details">
      ...
      <ul>
        <li><strong>Standard Shipping:</strong> Delivery within <strong>5-7 business days</strong>. Free for orders over $50; otherwise, a <strong>$5 flat rate</strong>.</li>
        <li><strong>Express Shipping:</strong> Delivery within <strong>2-3 business days</strong>. $15 flat rate for all orders.</li>
      </ul>
<br/>
...
<br/>
      ...
      <p>If your package is delayed, please wait an additional 2-3 business days as deliveries can be impacted by external factors. For packages marked as “Delivered” but not received, contact our Customer Support at <a href="mailto:support@shopit.com">support@shopit.com</a> within <strong>7 days</strong>.</p>
<br/>
      <h2>Damaged or Lost Packages</h2>
      <p>If your package arrives damaged or does not arrive at all, please reach out to our team immediately at <a href="mailto:support@shopit.com">support@shopit.com</a>. We’ll work with you to file a claim and arrange for a replacement or refund.</p>
<br/>
      <h2>Contact Us</h2>
      <p>If you have questions or need help with your order, our support team is here for you. Contact us at <a href="mailto:support@shopit.com">support@shopit.com</a> or call us at <strong>+1-800-123-4567</strong>.</p>
    </div>
  );
};
